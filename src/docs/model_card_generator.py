...
class ModelCardGenerator:
    ...
    def generate_card(self, model_name: str, model_version: str) -> dict[str, Any]:
        card = {
            ...
            "performance": {"accuracy": 0.7169, "latency_p95_ms": 21.75},
            "training_data": {"samples": 3341, "features": 5000},
            "limitations": ["Limited to 41 intent classes", "Performance may vary on new domains"],
        }
