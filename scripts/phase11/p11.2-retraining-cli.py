...
from retraining.trigger_engine import RetrainingTriggerEngine
from retraining.drift_integration import DriftIntegration
...
def cmd_start_retrain(args):
    ...
    from retraining.trigger_engine import TriggerEvent, TriggerType, TriggerSeverity
